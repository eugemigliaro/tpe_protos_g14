...
// Formato de entrada: YYYY-MM-DDTHH:MM:SSZ USUARIO DESTINO:PUERTO RESULTADO
// Las últimas LOG_RECENT_MAX entradas se mantienen en un buffer circular ---> respoden al comando GET_LOG sin I/O.
// El archivo en disco sirve para persistencia entre reinicios.

#define LOG_RECENT_MAX 100  /* entradas recientes guardadas en RAM */

/*
Abre el archivo de access log en path.
Si path es NULL no se persiste a disco (las entradas igualmente van al buffer circular en RAM).
